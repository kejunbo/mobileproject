...
class _UserThirdPageState extends State<UserThirdPage> {
  ...
  String urlUpdateAddress =
      "http://kejunbo.com/mobileproject/php/updateaddress.php";
  String urlPaymentDue =
      "http://kejunbo.com/mobileproject/php/paymentdue.php";
  String urlPayWithCredit =
      "http://kejunbo.com/mobileproject/php/paywithcredit.php";
  String urlGetNewCredit =
      "http://kejunbo.com/mobileproject/php/getnewcredit.php";
  String urlEditProfile =
      "http://kejunbo.com/mobileproject/php/editprofile.php";
  String urlUpdateProfilePic =
      "http://kejunbo.com/mobileproject/php/updateprofilepic.php";
  @override
  void initState() {
    super.initState();
    _getLocation();
